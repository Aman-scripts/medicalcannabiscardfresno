      ...
      <main id="main-content" className="overflow-x-hidden">
        <section className="bg-grid border-b border-border px-4 py-10 sm:px-5 sm:py-14 md:px-10 md:py-20">
          <div className="mx-auto max-w-[1240px]">
            ...
            <SectionEyebrow>Patient Feedback</SectionEyebrow>
            <h1 className="font-heading m-0 mb-4 max-w-3xl text-3xl font-semibold tracking-tight text-brand sm:text-4xl md:text-5xl">
              Reviews
            </h1>
            <p className="m-0 max-w-2xl text-[15px] leading-relaxed text-muted-foreground sm:text-base md:text-lg">
              At Medical Cannabis Card Fresno, we care about giving Fresno
              patients a smooth, dependable experience from start to finish. Our
              goal is always the same: clear guidance and responsible medical
              oversight throughout your evaluation.
            </p>
            <p className="mt-4 mb-0 max-w-2xl text-[15px] leading-relaxed text-muted-foreground sm:text-base">
        ...
        >
          <div className="mx-auto max-w-[1240px]">
            ...
            <p className="m-0 mb-10 max-w-2xl text-[15px] leading-relaxed text-muted-foreground">
              This section pulls in genuine reviews submitted through Google&apos;s
              verified review system, so what you see here reflects real
              experiences from real patients, not anything written by us.
            </p>
            ...
            <p className="mx-auto mt-8 mb-0 max-w-2xl text-center text-[15px] leading-relaxed text-muted-foreground">
              If you&apos;ve completed an evaluation with us, we&apos;d love to hear
              about your experience. Your feedback helps future patients know
              what to expect.
            </p>
          </div>
        </section>
